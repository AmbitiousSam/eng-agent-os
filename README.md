...
Options: `EAOS_NO_HOOKS=1` skips the hooks, `EAOS_REF=v4.5.2` pins a release, `EAOS_SRC=<dir>` moves
...
v4.5.2. Thirteen real runs on a private production codebase were reviewed and every defect they
