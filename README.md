...
Options: `EAOS_NO_HOOKS=1` skips the hooks, `EAOS_REF=v4.5.7` pins a release, `EAOS_SRC=<dir>` moves
...
v4.5.7. Seventeen real runs on a private production codebase were reviewed and every defect they
