#!/usr/bin/env python3
"""
test_eaos.py — stdlib unittest for runtime/eaos.
...
the exit-code contract in lab/reviews/2026-07-13-eaos-cli-spec.md.
"""
import json
import os
import subprocess
...
class TestExperimentOutcome(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "lab", "scripts", "experiment_outcome.py")
